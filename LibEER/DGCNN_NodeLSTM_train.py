...
# See models/DGCNN_NodeLSTM.py for architecture details.
#
# Example commands (same flags as DGCNN_LSTM_train.py):
#
# SEED sub-dependent (front-back split):
#   python DGCNN_NodeLSTM_train.py -onehot -batch_size 16 -lr 0.0015 -sessions 1 2 \
#       -epochs 80 -setting seed_sub_dependent_front_back_setting \
#       -sample_length 10 -stride 5
#
# SEED sub-dependent (train/val/test split):
#   python DGCNN_NodeLSTM_train.py -metrics acc macro-f1 -metric_choose macro-f1 \
...
def main(args):
    ...
    for rridx, (data_i, label_i) in enumerate(zip(data, label), 1):
        ...
        for ridx, (train_indexes, test_indexes, val_indexes) in enumerate(zip(tts['train'], tts['test'], tts['val']), 1):
            ...
            output_dir = make_output_dir(args, "DGCNN_NodeLSTM")
